...
# connect to the database created in data_cleaning.py
conn = sqlite3.connect(BASE + "\\data\\collisions.db")
cursor = conn.cursor()
...
# helper function - runs a query and returns a dataframe, same as recitation
