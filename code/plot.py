...
plt.tight_layout()
plt.savefig("plot1_crashes_by_hour.png")
plt.show()
print("saved plot1")
...
ax.set_xticks(range(0, 24))
plt.tight_layout()
plt.savefig("plot2_severity_by_hour.png")
plt.show()
print("saved plot2")
...
plt.tight_layout()
plt.savefig("plot3_rush_hour_severity.png")
plt.show()
print("saved plot3")
...
plt.tight_layout()
plt.savefig("plot4_weekend_severity.png")
plt.show()
print("saved plot4")
...
plt.tight_layout()
plt.savefig("plot5_night_severity.png")
plt.show()
print("saved plot5")
...
plt.tight_layout()
plt.savefig("plot6_crashes_by_borough.png")
plt.show()
print("saved plot6")
...
plt.tight_layout()
plt.savefig("plot7_factor_groups.png")
plt.show()
print("saved plot7")
...
plt.tight_layout()
plt.savefig("plot8_factor_severity.png")
plt.show()
print("saved plot8")
...
plt.tight_layout()
plt.savefig("plot9_num_vehicles_severity.png")
plt.show()
print("saved plot9")
...
if "number_of_cyclist_injured" in df.columns:
    ...
    ax.set_xticks(range(0, 24))
    plt.tight_layout()
    plt.savefig("plot10_cyclist_injuries.png")
    plt.show()
    print("saved plot10")
